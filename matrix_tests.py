...
class MatrixTests(unittest.TestCase):
    ...
    @details This class contains tests for addition, subtraction, scalar multiplication, matrix multiplication,
...
#--------------testing multiplication by scalar-----------
    def test_mul_scalar(self):
        ...
        @see matrix.Matrix.multiply_scalar
        """
